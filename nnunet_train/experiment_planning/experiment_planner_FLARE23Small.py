...
class ExperimentPlanner3D_FLARE23Small(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE23Small, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE23Small"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE23Small_plans_3D.pkl")
