...
class ExperimentPlanner3D_FLARE23TumorMedium(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE23TumorMedium, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE23TumorMedium"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE23TumorMedium_plans_3D.pkl")
