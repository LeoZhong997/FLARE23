...
class ExperimentPlanner3D_FLARE23TumorSmall(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_FLARE23TumorSmall, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_FLARE23TumorSmall"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansFLARE23TumorSmall_plans_3D.pkl")
