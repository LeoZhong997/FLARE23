...
base_dir = "/data/result/zhongzhiqiang/nnUNet/nnUNet_outputs/tensorrt_test"
...
def daemon_process(time_interval, json_path, gpu_index=1):
    ...
    while True:
        ...
        gpu_memory = (
            (meminfo.total - meminfo.free) // 1048576
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-save_dir", default="/data/result/zhongzhiqiang/nnUNet/nnUNet_outputs/predict_temp/tensorrt_test",
                        help="data save folder")
    parser.add_argument("-test_name", default="trt_test_fp16", help="data save folder")
    parser.add_argument("-py_fn_name", default="trt_test", help="data save folder")
    args = parser.parse_args()
    logger.info(f"evaluating...")
    json_dir = "{}/{}".format(args.save_dir, args.test_name)
    os.makedirs(json_dir, exist_ok=True)
    json_path = os.path.join(json_dir, "{}.json".format(args.test_name))
    ...
    try:
        ...
        p1.start()
        t0 = time.time()
        cmd = 'CUDA_VISIBLE_DEVICES={} /opt/conda/bin/python {} '.format(
            args.gpus, "/home/zhongzhiqiang/PreResearch/FLARE23/utilities/tensorrt/{}.py".format(args.py_fn_name))
