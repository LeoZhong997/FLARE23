...
from nnunet.utilities.nd_softmax import softmax_helper, numpy_softmax
...
class TRTModule(torch.nn.Module):
    ...
    def __init__(self, engine_path, num_classes, input_names=None, output_names=None):
        ...
        self.engine = build_engine(engine_path)
        self.check_engine()
    ...
    def _internal_maybe_mirror_and_pred_3D(self, x: Union[np.ndarray, torch.tensor], mirror_axes: tuple,
        ...
        batchTTA = False
        TTA4 = False
        print(">>>Debug TRTModule _internal_maybe_mirror_and_pred_3D TTA4, batchTTA, mirror_idx: ", TTA4, batchTTA, mirror_idx)
        if batchTTA:
...
class TensorRTSession(object):
    ...
    def _internal_maybe_mirror_and_pred_3D(self, x: Union[np.ndarray, torch.tensor], mirror_axes: tuple,
        ...
        batchTTA = False
        TTA4 = True
        print(">>>TensorRTSession TTA4, batchTTA, mirror_idx: ", TTA4, batchTTA, mirror_idx)
        if batchTTA:
            # x -> torch.Size([1, 1, 32, 128, 192]), torch.float32, [2, 3, 4] are index of z, y, x-axis
            # partial tta for batch inference
...
if __name__ == "__main__":
    ...
    trt_module = TRTModule(engine_pth, 15)
