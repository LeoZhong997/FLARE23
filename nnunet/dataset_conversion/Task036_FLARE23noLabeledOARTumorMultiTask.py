...
def process1(pid, image_dir, oar_tumor_pred_dir, target_imagesTr, target_labelsTr):
    ct = join(image_dir, pid + "_0000.nii.gz")
    ...
    if not (isfile(new_ct) and isfile(new_label)):
        ...
        if -1 not in ct_direction and -1 not in oar_tumor_pred_direction:
            ...
            print(pid, "correct image")


if __name__ == "__main__":
    num_processes = 8

    task_name = "Task036_FLARE23noLabeledOARTumorMultiTask"
